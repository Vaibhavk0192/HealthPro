  ...
  return (
    ...
    <nav className="navBar">
        ...
        <ul className="navBarList">
            <li><Link href="" className="navBarLinks">Seach Medicine</Link></li>
            <li><Link href="" className="navBarLinks">Seach Disease</Link></li>
            <li><Link href="" className="navBarLinks">What We Cover</Link></li>
