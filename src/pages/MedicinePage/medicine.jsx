    ...
    <div className="app__disease-box">
      ...
      <div className="app__disease-section2">
        ...
        <div className="app__disease-contentbox">
          ...
          Placeholderin is a fictitious medication used for demonstration and illustrative purposes only. It does not represent any real medication and should not be used as medical advice.
          </div>
        </div>
